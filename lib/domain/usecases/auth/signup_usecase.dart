...
class SignupUsecase
    implements UseCase<Either<Failure, UserEntity>, CreateUserReq> {
  @override
  Future<Either<Failure, UserEntity>> call(CreateUserReq params) async {
    return sl<AuthRepositoryImpl>().signup(params);
  }
}
